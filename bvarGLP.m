...
[fh,r.postmax.betahat,r.postmax.sigmahat,omega,epshat,Vaux]=logMLVAR_formin(xh,y,x,lags,T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,hyperpriors,priorcoef);

r.postmax.epshat  = epshat;
r.postmax.V = Vaux;
r.postmax.omega   = omega;
r.postmax.bprior  = b;
r.lags = lags;                      % # lags
